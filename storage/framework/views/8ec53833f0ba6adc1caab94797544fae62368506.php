        ...
        <div class="section-content">
          <div class="card-deck px-5 ">
            ...
            <div class="col-md-3 card" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
              <img class="card-img-top" width="100%" height="150px" src="upload/news/<?php echo e($new->image); ?>">
              <div class="card-body">
                <a href="news/<?php echo e($new->id); ?>/<?php echo e($new->titlenone); ?>.html">
                  <h5 style="height: 30px;" class="card-title blue-text"><?php echo e($new->title); ?></h5>
                </a>
                <small class="text-muted">Posted <?php echo e(Carbon\Carbon::parse($new->created_at)->diffForHumans()); ?></small>
          ...
          <hr>
          <div style="text-align: center;"><?php echo e($news->links()); ?></div>
        </div>
...
</section><?php /**PATH C:\xampp\htdocs\gem\resources\views/frontend/pages/news.blade.php ENDPATH**/ ?>